...
For more information on interacting with running devices,
see [here](https://developer.android.com/agents/skills/android-cli/base/references/interact)

## Running journey tests

For more information on running journeys,
see [here](https://developer.android.com/agents/skills/android-cli/base/references/journeys)
...
info
Usage: android info Print environment information (SDK Location, etc.) The specific field to print
the value of. If omitted print all.
