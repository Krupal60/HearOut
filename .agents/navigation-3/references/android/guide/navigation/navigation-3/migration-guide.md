...
> [!IMPORTANT]
> **Important:** We released an agent skill to help you install and migrate to Jetpack Navigation 3.
> Try out the skill from the [Android skills repository](https://github.com/android/skills).
